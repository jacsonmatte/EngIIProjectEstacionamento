...
function buscarPlanosCliente($idCliente, $dataInicial, $dataFinal, $ordenar) {
	...
	$sql = "SELECT p.nome nome, p.valor valor, p.horas horas, p.valor_excedente excedente, pc.data_contrato data FROM plano_contratado pc JOIN plano p ON p.id = pc.plano_id_plano WHERE cliente_id_cliente = $idCliente";
